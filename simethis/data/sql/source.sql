COPY( 
	WITH
		...
		WHERE r.id_org_f IS NOT NULL AND r.meta_id_groupe <> 1 AND r.insee_dept IN ('04', '05', '01', '26', '38', '73', '74')
		),
		partners_cbna AS ( 
		SELECT DISTINCT ON (o.nom)
		o.nom,
		...
		FROM flore.releve r 
		JOIN referentiels.organisme o ON o.id_org = r.id_org_f 
		WHERE r.id_org_f IS NOT NULL AND r.meta_id_groupe = 1 AND r.id_org_f <> 2785 AND r.insee_dept IN ('04', '05', '01', '26', '38', '73', '74')
		)
